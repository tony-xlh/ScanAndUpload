<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ScanAndUpload.index" %>
...
<body>
    ...
    <p><%Response.Write("Your IP address is " + Request.ServerVariables["REMOTE_ADDR"]);%></p>
    ...
    <script type="text/javascript">
        ...
        function OnServerReturnedSomething(errorCode, errorString, sHttpResponse) {
        	...
        	if (response.status=="success"){
        		...
        		link.href = "./Get.aspx?filename="+response.filename;
        ...
        function UploadImage() {
            if (DWObject) {
                ...
                var endPoint = CurrentPath + "Upload.aspx";
